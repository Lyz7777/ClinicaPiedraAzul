      ...
      <div className="flex">
        ...
        >
          <nav className="p-4 space-y-2">
            <button className="w-full flex items-center space-x-3 px-4 py-3 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white shadow-lg">
        ...
        <main className="flex-1 p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <Card key={index} className="p-6 rounded-3xl border-0 shadow-lg hover:shadow-xl transition-shadow">
